...
class H(BaseHTTPRequestHandler):
 ...
 def do_POST(self):
  ...
  lib=EffectLibrary(ROOT/'data'/'Ad_Manthan_Effect_Shortcut_Library_v0_1.xlsx'); out=AdManthan(lib).generate_15s_6(body.get('brand',''),body.get('product',''),body.get('objective','brand awareness'))
