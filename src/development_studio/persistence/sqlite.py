...
CREATE TABLE IF NOT EXISTS execution_requests (id TEXT PRIMARY KEY, request_id TEXT NOT NULL UNIQUE, project_id TEXT NOT NULL, task_id TEXT, plan_decision_ref TEXT NOT NULL, authorization_decision_ref TEXT NOT NULL, selected_route_ref TEXT NOT NULL, capability_ref TEXT NOT NULL, provider_type TEXT NOT NULL, provider_ref TEXT NOT NULL, inputs TEXT NOT NULL, authorized_scope TEXT NOT NULL, constraints TEXT NOT NULL, escalation_conditions TEXT NOT NULL, provenance TEXT NOT NULL, status TEXT NOT NULL);
CREATE TABLE IF NOT EXISTS execution_results (id TEXT PRIMARY KEY, execution_id TEXT NOT NULL UNIQUE, request_id TEXT NOT NULL, status TEXT NOT NULL, outputs TEXT NOT NULL, evidence_refs TEXT NOT NULL, failure_information TEXT NOT NULL, escalation_information TEXT NOT NULL, provenance TEXT NOT NULL, FOREIGN KEY(request_id) REFERENCES execution_requests(request_id));
"""
JSON_FIELDS = {"tasks": ("inputs", "outputs"), "artifacts": ("source_references",), "builds": ("input_refs", "output_refs"), "test_runs": ("evidence",), "releases": ("artifact_refs",), "events": ("inputs", "outputs", "source_references"), "capabilities": ("required_inputs", "expected_outputs", "constraints", "authority_scope", "escalation_conditions", "provenance"), "routing_entries": ("selection_conditions", "authority_scope", "escalation_conditions", "provenance"), "execution_requests": ("inputs", "authorized_scope", "constraints", "escalation_conditions", "provenance"), "execution_results": ("outputs", "evidence_refs", "failure_information", "escalation_information", "provenance")}
TABLES = {"projects","requirements","tasks","agent_assignments","dependencies","artifacts","builds","test_runs","approvals","retries","checkpoints","releases","events","capabilities","routing_entries","execution_requests","execution_results"}
