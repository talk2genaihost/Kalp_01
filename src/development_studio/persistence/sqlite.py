...
"""
JSON_FIELDS = {"tasks": ("inputs", "outputs"), "artifacts": ("source_references",), "builds": ("input_refs", "output_refs"), "test_runs": ("evidence",), "releases": ("artifact_refs",), "events": ("inputs", "outputs", "source_references")}
TABLES = {"projects","requirements","tasks","agent_assignments","dependencies","artifacts","builds","test_runs","approvals","retries","checkpoints","releases","events"}
